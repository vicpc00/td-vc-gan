...
class WaveDataset(Dataset):
    ...
    def __init__(self, dataset_file, speaker_file, sample_rate=24000, max_segment_size = None, return_index = False, augment_noise = None, silence_threshold=None, add_new_spks = False):
